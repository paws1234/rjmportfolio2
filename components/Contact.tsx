    ...
    <Card title="Contact">
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <div className="rounded-2xl border border-neutral-200 dark:border-neutral-800 p-4">
          ...
          <p className="text-xs text-neutral-500 dark:text-neutral-400 mt-3">Speaking</p>
          <p className="text-sm text-neutral-700 dark:text-neutral-300 mt-1">{resume.community.speaking}</p>
        </div>
      </div>
    </Card>
  );
